...
import { ArrowLeft, AlertCircle, Lightbulb, UploadCloud } from "lucide-react";
    ...
    <div className="relative min-h-screen bg-[radial-gradient(1200px_700px_at_0%_0%,rgba(99,102,241,0.25),transparent_55%),radial-gradient(900px_700px_at_100%_15%,rgba(147,51,234,0.18),transparent_55%),linear-gradient(to_bottom_right,#f8fafc,#eef2ff,#f1f5f9)]">
      ...
      <main className="mx-auto max-w-6xl px-6 pb-10 pt-6 md:pt-28">
        <div className="grid items-start gap-6 lg:grid-cols-[1.35fr_0.85fr]">
          {/* LEFT: Form (stays first on mobile) */}
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <div className="flex items-center gap-2 text-sm font-medium">
                        ...
                        <span>Pilih / Tarik & drop foto di sini</span>
                      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="relative overflow-hidden rounded-[26px] bg-[#25d366] shadow-[0_18px_45px_rgba(0,0,0,0.10)]">
              <div className="relative z-10 p-6">
                <div className="text-lg font-extrabold text-white">
                  Butuh bantuan lebih lanjut?
                </div>
                <p className="mt-1 text-sm text-white/90">
                  Jika bingung atau keadaan darurat, hubungi Admin Sarpras langsung.
                </p>

                <Button
                  asChild
                  className="mt-4 h-10 rounded-xl bg-white text-green-400 font-semibold hover:bg-green-50"
                >
                  <a href="https://wa.me/62" target="_blank" rel="noreferrer">
                    <SiWhatsapp size={16} color="default" className="text-[#25d366]" />
                    Chat Admin
                  </a>
                </Button>
              </div>
              ...
              <SiWhatsapp
                size={120}
                color="#FFFFFF"
                className="pointer-events-none absolute -bottom-5 right-0 opacity-75"
              />
            </div>
          </div>
        </div>
